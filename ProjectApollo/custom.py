...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("damage", 1, "deflation_damage")
        self.add_class("damage", 2, "side_through_cut")
        self.add_class("damage", 3, "impact_bulge")
        self.add_class("damage", 4, "runflat" )
        ...
        for a in annotations:
            ...
            for n in objects:
                try:
                    if n['name'] == 'deflation_damage':
                        num_ids.append(1)
                    elif n['name'] == 'side_through_cut':
                        num_ids.append(2)
                    elif n['name'] == 'impact_bulge':
                        num_ids.append(3)
                    elif n['name'] == 'runflat':
                        num_ids.append(4)
                except:
